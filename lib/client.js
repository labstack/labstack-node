...
class Client {
  ...
  pdfExtractImage(request) {
    const body = new FormData()
    body.append('file', fs.createReadStream(request.file))
    return this._request('POST', '/pdf/extract-image', body, false)
  }
  ...
  textSpellCheck(request) {
    return this._request('POST', '/text/spell-check', request, true)
  }
  ...
  webpageToPdf(request) {
    return this._request('POST', '/webpage/to-pdf', request, true)
  }
